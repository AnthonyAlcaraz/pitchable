...
const BUILT_IN_THEMES: ThemeDefinition[] = [
  ...
  // 17. Linear Startup — inspired by Linear/Notion minimal SaaS aesthetic
  {
    name: 'linear-startup',
    displayName: 'Linear Startup',
    description: 'Clean white background with indigo accent and slate text. Linear/Notion-inspired minimal SaaS aesthetic.',
    primaryColor: '#1e293b',
    secondaryColor: '#64748b',
    accentColor: '#5e6ad2',
    backgroundColor: '#ffffff',
    ...
    meta: {
      imageFrequency: 'rare',
      bestForAudience: ['INVESTORS', 'TECHNICAL', 'CUSTOMERS'],
      bestForGoals: ['RAISE_FUNDING', 'SELL_PRODUCT', 'GET_BUYIN'],
      suggestedFrameworks: ['PRODUCT_FIRST', 'POPP', 'PAS'],
      category: 'light',
      defaultLayoutProfile: 'startup',
    },
  },

  // 18. SaaS Dark — inspired by Vercel/Supabase docs aesthetic
  {
    name: 'saas-dark',
    displayName: 'SaaS Dark',
    description: 'Near-black background with emerald accent. Vercel/Supabase developer docs aesthetic.',
    primaryColor: '#f8fafc',
    secondaryColor: '#94a3b8',
    accentColor: '#10b981',
    ...
    meta: {
      ...
      bestForAudience: ['TECHNICAL', 'INVESTORS', 'CUSTOMERS'],
      bestForGoals: ['SELL_PRODUCT', 'RAISE_FUNDING', 'EDUCATE'],
      suggestedFrameworks: ['PAS', 'STAR', 'PRODUCT_FIRST'],
      category: 'dark',
      defaultLayoutProfile: 'startup',
    },
  },
